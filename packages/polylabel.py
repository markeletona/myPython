"""
python port of polylabel algorithm: https://github.com/mapbox/polylabel.
SOURCE:github.com/Justin-Kuehn/polylabel-py

Modified and updated by Markel Gómez Letona.
...
def polylabel(polygon: list, precision: float = 1.0):
    """
    Find the 'pole of inaccessibility', the most distant point from the polygon
    outline.
